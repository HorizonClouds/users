...
describe('Following Service', () => {
  ...
  describe('getFollowers', () => {
    it('should return followers successfully', async () => {
      ...
      // Simula la obtención de los seguidores
      findStub.resolves(mockFollowers);
  ...
  describe('getFollowedUsers', () => {
    it('should return followed users successfully', async () => {
      ...
      const mockFollowedUsers = [{ name: 'Alice', email: 'alice@example.com' }, { name: 'Bob', email: 'bob@example.com' }];

      // Simula la obtención de los usuarios seguidos
      findStub.resolves(mockFollowedUsers);
